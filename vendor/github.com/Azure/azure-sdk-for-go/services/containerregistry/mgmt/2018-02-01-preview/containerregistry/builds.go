...
// name of the container registry. buildID is the build ID.
...
//
// resourceGroupName is the name of the resource group to which the container registry belongs. registryName is the
// name of the container registry. filter is the builds filter to apply on the operation. top is $top is supported
// for get list of builds, which limits the maximum number of builds to return. skipToken is $skipToken is
// supported on get list of builds, which provides the next page in the list of builds.
...
//
// resourceGroupName is the name of the resource group to which the container registry belongs. registryName is the
// name of the container registry. buildID is the build ID. buildUpdateParameters is the build update properties.
