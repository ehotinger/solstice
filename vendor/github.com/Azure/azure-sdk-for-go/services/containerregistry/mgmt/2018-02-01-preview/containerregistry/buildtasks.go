...
// buildTaskCreateParameters is the parameters for creating a build task.
...
//
// resourceGroupName is the name of the resource group to which the container registry belongs. registryName is the
// name of the container registry. filter is the build task filter to apply on the operation. skipToken is
...
// resourceGroupName is the name of the resource group to which the container registry belongs. registryName is the
// name of the container registry. buildTaskName is the name of the container registry build task.
// buildTaskUpdateParameters is the parameters for updating a build task.
